...
%Update 4/2015 Rob Harrigan
%Default behavior of the rng is to return the same random number stream
%at the start of each matlab session, this changes that behavior
rng shuffle
